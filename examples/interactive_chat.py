...
def create_reasoning_agent(api_key: str, debug: bool = False) -> Agent:
    """Create a reasoning agent (grok-4.6 with reasoning_effort)."""
    model = xAIModel(
        client_args={"api_key": api_key},
        model_id="grok-4.6",
...
def print_menu() -> None:
    ...
    print("  7. Reasoning (grok-4.6)")
    print("  8. Reasoning encrypted (grok-4.6)")
    print("  9. Reasoning encrypted DEBUG (grok-4.6 + logging)")
...
def main() -> None:
    ...
    agents = {
        ...
        "7": ("Reasoning (grok-4.6)", lambda: create_reasoning_agent(api_key), True),
        "8": ("Reasoning encrypted (grok-4.6)", lambda: create_reasoning_encrypted_agent(api_key), True),
...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1:
        ...
        agents = {
            ...
            "7": ("Reasoning (grok-4.6)", lambda: create_reasoning_agent(api_key, debug), True),
            "8": ("Reasoning encrypted (grok-4.6)", lambda: create_reasoning_encrypted_agent(api_key, debug), True),
            "9": ("Reasoning encrypted DEBUG", lambda: create_reasoning_encrypted_debug_agent(api_key), True),
